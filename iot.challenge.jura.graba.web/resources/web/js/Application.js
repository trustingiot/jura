define( ["react", "js/header/Header", "js/Main", "js/Footer"], function( React, Header, Main, Footer ) {
	return class Application extends React.Component {
		constructor( props ) {
			...
			this.sections = ['Home', 'Sneak', 'Graba'];
		...
		render() {
			...
			return React.createElement( 'div', { className: className },
				React.createElement( Header, { title: 'Graba', setSection: this.setSection, section: this.state.section, sections: this.sections } ),
				React.createElement( Main, { alias: 'Graba web', section: this.state.section, vertical: vertical } ),
